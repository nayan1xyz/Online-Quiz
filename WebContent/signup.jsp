                    ...
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="Register" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="email" id="email" class="form-control" autofocus="on" autocomplete="off" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group text-center">
                                    <a class="signup" href="login.jsp">Login</a><br>
                              <input type="submit" name="submit" class="btn btn-info btn-md mt-3" value="Sign up">
                            </div>
                        </form>
                    </div>
                </div>
